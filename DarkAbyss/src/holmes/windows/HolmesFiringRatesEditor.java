...
public class HolmesFiringRatesEditor extends JFrame {
	...
	private TransFiringRateVector frData;
	private int frIndex;
	 ...
	 */
	public HolmesFiringRatesEditor(JFrame parent, TransFiringRateVector frData, int frIndex) {
		...
		vectorDescrTextArea.addFocusListener(new FocusAdapter() {
			public void focusLost(FocusEvent e) {
            	...
            	if(field != null) {
            		...
            		firingRatesManager.setStateDescription(frIndex, newComment);
            		fillTable();
            	}
            }
        });
