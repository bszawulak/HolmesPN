...
public class GUIManager extends JPanel implements ComponentListener {
	...
	/**
	 * Zwraca obiekt przycisku powiêkszaj¹cego okno do rozmiarów ekranu.
	...
	/**
	 * Ustawia obiekt przycisku powiêkszaj¹cego okno do rozmiarów ekranu.
	...
	/**
	 * Zwraca obiekt przycisku pomniejszaj¹cego okno do paska zadañ.
	...
	/**
	 * Ustawia obiekt przycisku pomniejszaj¹cego okno do paska zadañ.
	...
	/**
	 * Metoda zwraca œcie¿kê do katalogu narzedzi.
	 * @return String
	 */
	...
	/**
	 * Metoda zwraca œcie¿kê do katalogu programu.
	 * @return String
	 */
	...
	/**
	 * Metoda zwraca œcie¿kê do katalogu plików tymczasowych.
	 * @return String
	 */
...
// ************************************************************************************************
	...
	/**
	 * Metoda zwraca status œrodowiska narzêdziowego R.
	 * @return boolean - true, jeœli Abyss dysponuje prawid³ow¹ œcie¿k¹ dostêpu do Rscript.exe
	 */
