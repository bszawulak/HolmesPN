...
public class StateSimDataContainer {
    public ArrayList<ArrayList<Double>> transitionsStatistics = new ArrayList<>();
    ...
    public ArrayList<ArrayList<Double>> fullTokensHistory = new ArrayList<>();
    ...
    public ArrayList<Double> avgFired = new ArrayList<>();
    public ArrayList<Double> avgTimeForStep = new ArrayList<>();
